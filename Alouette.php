...
class Alouette {
	...
	static public function chanson($oiseau, $qualite, $action, $membres) {
		...
		$resultat .= '</div>';
		$resultat .= '</div>';
		$resultat .= '<div class="appel">Je '.$action.' '.$membres.'</div>';
		$resultat .= '<div class="reponse">Je '.$action.' '.$membres.'</div>';
		$resultat .= '<div class="appel">Et '.$membres.'</div>';
		$resultat .= '<div class="reponse">Et '.$membres.'</div>';
